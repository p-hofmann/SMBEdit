...
class Style1Wedge(StyleBasic):
    ...
    def _mirror_x(self):
        ...
        self._int_24bit = self.modify_orientation(self._int_24bit, rotations=rotations)
    ...
    def _mirror_y(self):
        ...
        if rotations % 2 == 1:
            rotations = (rotations + 2) % 4
        self._int_24bit = self.modify_orientation(self._int_24bit, axis_rotation=axis_rotation, rotations=rotations)
