...
class Meta(DefaultLogging):
    ...
    def __init__(self, logfile=None, verbose=False, debug=False):
        ...
        self._data_type_2 = DataType2(
            logfile=logfile, verbose=verbose, debug=debug)
        self._data_type_3 = DataType3(
            logfile=logfile, verbose=verbose, debug=debug)
        self._data_type_4 = DataType4(
            logfile=logfile, verbose=verbose, debug=debug)
        self._data_type_5 = DataType5(
            logfile=logfile, verbose=verbose, debug=debug)
        self._data_type_6 = DataType6(
            logfile=logfile, verbose=verbose, debug=debug)
        self._data_type_7 = DataType7(
            logfile=logfile, verbose=verbose, debug=debug)
        return
    ...
    def _read_file(self, input_stream):  # avt.class
        ...
        assert len(self.tail_data) == 0, "Unknown byte left: #{}".format(
            len(self.tail_data))
