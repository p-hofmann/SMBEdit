...
class BlockConfigHardcoded(object):
    ...
    @type rgba_color_map_armor: dict[(int, int, int), dict(int, int)]
    """

    rgba_color_map_armor = {
        (  0,   0,   0): {255: 603, 127: 593, 0:  63},  # black
        (255, 255, 255): {255: 608, 127: 507},  # white
        (240, 240, 240): {255: 608, 127: 507},  # white
        (128,   0, 128): {255: 613, 127: 537},  # purple
        (  0, 255, 255): {255: 618, 127: 532},  # cyan
        (  0, 191, 255): {255: 618, 127: 532},  # Deepskyblue
        (  0,   0, 192): {255: 618, 127: 532},  # blue
        (  0,   0, 128): {255: 618, 127: 532},  # blue / Navy
        (  0, 255,   0): {255: 623, 127: 527},  # green / lime
        ( 64, 173,  38): {255: 623, 127: 527},  # green
        (  0, 128,   0): {255: 623, 127: 527},  # green
        (  0, 100,   0): {255: 623, 127: 527},  # dark green
        (255, 255,   0): {255: 628, 127: 522},  # yellow
        (255, 217,   0): {255: 628, 127: 522},  # yellow
        (255, 165,   0): {255: 633, 127: 517},  # orange
        (255, 140,   0): {255: 633, 127: 517},  # dark orange
        (255,   0,   0): {255: 638, 127: 512},  # red
        (203,   0,   0): {255: 638, 127: 512},  # red
        (140,   0,   0): {255: 638, 127: 512},  # dark red
        (139,  69,  19): {255: 643, 127: 690},  # sattle brown
        (165,  42,  42): {255: 643, 127: 690},  # brown 139,69,19
        (  0, 128, 128): {255: 878, 127: 883},  # teal
        (255,  20, 147): {255: 912, 127: 917},  # deep pink
        (255,   0, 255): {255: 912, 127: 917},  # pink / Magenta / Fuchsia

        ( 53,  53,  53): {255: 828, 127: 828},  # dark grey
        (117, 117, 117): {255: 598, 127: 598},  # grey
        }
    ...
    activatable_ids = {
        ...
        922, 923, 415, 417, 937, 942, 943, 944, 945, 946, 947, 948, 949, 950, 951, 952, 953, 954, 955, 956, 957, 958,
