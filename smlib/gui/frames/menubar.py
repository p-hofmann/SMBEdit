...
class MenuBar(ActionMenuBar):
    ...
    def __init__(self, window, main_frame, smbedit):
        ...
        self.menu_file_import_3d_model_colored = QAction('Import colored...', window)
        menu_file_import.addAction(self.menu_file_import_3d_model)
        menu_file_import.addAction(self.menu_file_import_3d_model_colored)
        ...
        self.menu_tools_turn = QAction('Turn/Tilt', window)
        ...
        menu_tools.addAction(self.menu_tools_turn)
        ...
        self.menu_tools_turn.setShortcut('Alt+4')
        self.menu_tools_replace.setShortcut('Alt+5')
        self.menu_tools_misc.setShortcut('Alt+6')
        ...
        self.menu_file_import_3d_model_colored.triggered.connect(self._dialog_file_import_colored)
        ...
        self.menu_tools_turn.triggered.connect(lambda: self._main_frame.tool.display(3))
        self.menu_tools_replace.triggered.connect(lambda: self._main_frame.tool.display(4))
        self.menu_tools_misc.triggered.connect(lambda: self._main_frame.tool.display(5))
